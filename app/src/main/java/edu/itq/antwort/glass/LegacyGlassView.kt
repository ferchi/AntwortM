...
class LegacyGlassView : FrameLayout {
    ...
    private fun setupStyleable(context: Context, attrs: AttributeSet?) {
        val typedArray = context.obtainStyledAttributes(attrs, R.styleable.LegacyGlassView)
        this.cornerRadius = typedArray.getDimension(R.styleable.LegacyGlassView_legacyGlassView_cornerRadius, 25f)
        this.padding = typedArray.getDimension(R.styleable.LegacyGlassView_legacyGlassView_elevation, 24f)
        this.surfaceOpacity = typedArray.getFloat(R.styleable.LegacyGlassView_legacyGlassView_surfaceOpacity, 0.15f)
        this.borderOpacity = typedArray.getFloat(R.styleable.LegacyGlassView_legacyGlassView_borderWidth, 0.28f)
        this.shadowOpacity = typedArray.getFloat(R.styleable.LegacyGlassView_legacyGlassView_shadowOpacity, 0.19f)
        this.borderWidth = typedArray.getDimension(R.styleable.LegacyGlassView_legacyGlassView_borderWidth, 3f)
        this.blurAmount = typedArray.getInteger(R.styleable.LegacyGlassView_legacyGlassView_blurAmount, 25)
        typedArray.recycle()
